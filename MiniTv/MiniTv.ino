...
Arduino_GFX *gfx = new Arduino_ST7789(bus, TFT_RST, 1 /* rotation */, true /* IPS */, 240 /* width */, 288 /* height */, 0 /* col offset 1 */, 20 /* row offset 1 */, 0 /* col offset 2 */, 12 /* row offset 2 */);
...
void setup()
{
  ...
  //spi.begin(18 /* SCK */, 19 /* MISO */, 23 /* MOSI */, 5 /* CS */);
  
  if (!SD.begin(13, spi, 8000000))
